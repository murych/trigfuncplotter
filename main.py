...
class TestFrame(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        wx.Frame.__init__(self, parent, title=title,
                          size=(testframesize[0], testframesize[1]), style=wx.MINIMIZE_BOX | wx.SYSTEM_MENU |
        ...
        self.sibut = wx.Button(
            self.p2, -1, "Zoom", size=(fist_row_elements_size[0], fist_row_elements_size[1]), pos=(10, 10))
        self.sibut.Bind(wx.EVT_BUTTON, self.zoom)

        self.hibut = wx.Button(
            self.p2, -1, "Pan", size=(fist_row_elements_size[0], fist_row_elements_size[1]), pos=(70, 10))
        self.hibut.Bind(wx.EVT_BUTTON, self.pan)

        self.hmbut = wx.Button(
            self.p2, -1, "Home", size=(fist_row_elements_size[0], fist_row_elements_size[1]), pos=(130, 10))
        ...
        self.colorpicker = wx.Button(self.p2, -1, "Pick Color",
                                     size=(fist_row_elements_size[2], fist_row_elements_size[1]), pos=(430, 45))
        ...
        menuHelp = helpmenu.Append(
            wx.ID_ANY, '&Help', 'Help with usage of this program')
...
Suite 330, Boston, MA  02111-1307  USA"""
    ...
    def OnHelp(self, e):
        help_window = HelpWindow(
            None, 'Help', wx.CLOSE_BOX | wx.MINIMIZE_BOX | wx.CAPTION)
        help_window.Show()

    def OnChange(self, e):
        changelog_window = ChangelogWindow(
            None, 'Changelog', wx.CLOSE_BOX | wx.MINIMIZE_BOX | wx.CAPTION)
...
<ul>\
    ...
    <ul>\
        <li>added improved color picker for graphs - now You can use RGB or HEX color code</li>\
        <li>added new types to save plot - <em>svg, pdf, jpeg</em> (You must write in &#39;name&#39; section</li>\
    </ul>\
...
class HelpWindow(wx.Frame):
    ...
    def __init__(self, parent, title, style):
        wx.Frame.__init__(
            self, parent, title=title, size=(450, 400), style=style)
